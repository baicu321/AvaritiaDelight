...
import committee.nova.mods.avaritiadelight.item.block.entity.*;
...
public final class ADBlockEntities {
    ...
    public static final RegistrySupplier<BlockEntityType<StarCampFireBlockEntity>> STAR_CAMPFIRE = register("star_campfire", () -> BlockEntityType.Builder.create(StarCampFireBlockEntity::new, ADBlocks.STAR_CAMPFIRE.get()).build(null));
